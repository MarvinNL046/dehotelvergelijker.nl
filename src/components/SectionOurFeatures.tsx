...
const SectionOurFeatures: FC<Props> = ({
  ...
  type = 'type1',
  subHeading = 'Voordelen',
  heading = 'Waarom DeHotelVergelijker.nl?',
  listItems = [
    {
      badge: 'Vergelijk',
      title: 'Alle prijzen op één plek',
      description: 'Vergelijk prijzen van Booking.com, Hotels.com, Expedia en meer in één overzicht',
    },
    {
      badge: 'Bespaar',
      badgeColor: 'green',
      title: 'Tot 80% korting',
      description: 'Vind de beste deals en bespaar gemiddeld 30% op je hotelboeking',
    },
    {
      badge: 'Veilig',
      badgeColor: 'red',
      title: 'Betrouwbaar boeken',
      description: 'Boek direct bij vertrouwde partners met veilige betaalmethoden en garanties',
    },
  ],
}) => {
  return (
